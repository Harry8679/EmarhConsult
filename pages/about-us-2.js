            ...
            >
              <div className="col-md-4">
                <div className="icon-bx-wraper style-6 text-center m-b30 icon-up">
                  ...
                  <div className="icon-content">
                    ...
                    <p>
                      Nous vous accompagnons dans la conception de votre projet.
                      Ce que vous voulez réaliser et les technologies adaptées.
                    </p>
                  </div>
                </div>
              </div>
              <div className="col-md-4">
                <div className="icon-bx-wraper style-6 text-center m-b30 icon-up">
                  ...
                  <div className="icon-content">
                    <h4 className="dlab-title m-b15">Développement</h4>
                    <p>
                      La Conception ayant été faites, nous nous tournons vers 
                      la réalisation de votre projets ainsi que les tests requis pour son fonctionnement.
                    </p>
                  </div>
                </div>
              </div>
              <div className="col-md-4">
                <div className="icon-bx-wraper style-6 text-center m-b30 icon-up">
                  ...
                  <div className="icon-content">
                    <h4 className="dlab-title m-b15">Déploiement</h4>
                    <p>
